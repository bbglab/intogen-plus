...
system ("Rscript", "/edriver/binomial_e-Driver.r", "$name_perl_out", "$ARGV[4]");
if ($?) {
	die "I COULD GENERATE THE PERL OUTPUT, BUT THERE WAS SOME PROBLEM RUNNING THE Rscript \"/e-Driver/binomial_e-Driver.r\"\n";
}
