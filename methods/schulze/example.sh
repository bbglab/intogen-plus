...
python Parser.py --input /home/jordeu/workspace/intogen/intogen-plus/output --cancer KICH --output /home/jordeu/workspace/intogen/intogen-plus/output/schulze/KICH.out.gz

# Optimize a couple of cancer types
# python optimizer.py --seeds 1 --niter 1 --epsilon 0.1 --foutput /workspace/projects/intogen/test/output_optimization/
# --input_rankings /workspace/projects/intogen/test/dict_rankings.pickle --cancer BRCA
# --discarded_methods /workspace/projects/intogen/intogen4/runs/intogen4_20170614/plots/discarted_analyses.txt --t_combination RANKING
