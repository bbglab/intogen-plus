...
process PreprocessFromInput {
    ...
    """
    python $baseDir/intogen4.py preprocess --cores $task.cpus -i $INPUT -o . vep oncodrivefml oncodriveclustl
    """
...
process PreprocessFromVep {
    ...
    """
    python $baseDir/intogen4.py read -i $task_file -o . hotmapssignature edriver deconstructsig
    """
}
