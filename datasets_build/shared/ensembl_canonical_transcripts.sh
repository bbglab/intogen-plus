...
mysql -u anonymous -h ensembldb.ensembl.org --column-names=FALSE -e "${SQL_QUERY};" ${ENSEMBL_DATABASE} > ../../datasets/${INTOGEN_GENOME}_${INTOGEN_VEP}_${INTOGEN_RELEASE}/shared/ensembl_canonical_transcripts.tsv