...
echo "library(dndscv); buildref(\"../../datasets/${INTOGEN_GENOME}_${INTOGEN_VEP}_${INTOGEN_RELEASE}/shared/cds_biomart.tsv\", \"${GENOME}\", outfile = \"../../datasets/${INTOGEN_GENOME}_${INTOGEN_VEP}_${INTOGEN_RELEASE}/RefCDS.rda\")" | singularity exec ../../containers/${INTOGEN_RELEASE}/dndscv.simg R --no-save
